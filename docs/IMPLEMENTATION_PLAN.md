...
- About、Interests、Education 和 Contact 合并到 Home；Interests 与 Education 使用响应式双栏并直接归入个人陈述区域，首页不设独立 Selected work 或 Technical toolkit 板块。
...
- Home：个人陈述、研究/职业双入口、并列的个人兴趣与本科/PhD 教育背景、contact/footer。
